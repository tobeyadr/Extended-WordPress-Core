...
abstract class DB {
    ...
    public function register_table() {
        global $wpdb;
        $wpdb->__set( $this->get_filter_prefix() . '_' . $this->get_object_type() . 's', $this->get_table_name() );
    ...
    public function get_cache_group(){
        return $this->get_filter_prefix() . '_' . $this->get_object_type() . 's';
    }
    ...
    public function get( $row_id ) {
        global $wpdb;
        return apply_filters( "{$this->get_filter_prefix()}/db/get/{$this->get_object_type()}"  , $wpdb->get_row( $wpdb->prepare( "SELECT * FROM $this->table_name WHERE $this->primary_key = %s LIMIT 1;", $row_id ) ) );
    }
    ...
    public function get_by( $column, $row_id ) {
        ...
        return apply_filters( "{$this->get_filter_prefix()}/db/get_by/{$this->get_object_type()}", $wpdb->get_row( $wpdb->prepare( "SELECT * FROM $this->table_name WHERE $column = %s LIMIT 1;", $row_id ) ) );
    }
    ...
    public function get_column( $column, $row_id ) {
        global $wpdb;
        $column = esc_sql( $column );
        return apply_filters( "{$this->get_filter_prefix()}/db/get_column/{$this->get_object_type()}", $wpdb->get_var( $wpdb->prepare( "SELECT $column FROM $this->table_name WHERE $this->primary_key = %s LIMIT 1;", $row_id ) ) );
    }
    ...
    public function get_column_by( $column, $column_where, $column_value ) {
        ...
        $column       = esc_sql( $column );
        return apply_filters( "{$this->get_filter_prefix()}/db/get_column_by/{$this->get_object_type()}", $wpdb->get_var( $wpdb->prepare( "SELECT $column FROM $this->table_name WHERE $column_where = %s LIMIT 1;", $column_value ) ) );
    }
    ...
    public function insert( $data ) {
        ...
        do_action( "{$this->get_filter_prefix()}/db/pre_insert/{$this->get_object_type()}", $data );
        ...
        do_action( "{$this->get_filter_prefix()}/db/post_insert/{$this->get_object_type()}", $wpdb_insert_id, $data );
    ...
    public function update( $row_id = 0, $data = [], $where = [] ) {
        ...
        do_action( "{$this->get_filter_prefix()}/db/pre_update/{$this->get_object_type()}", $where, $data );

        $data = apply_filters( "{$this->get_filter_prefix()}/db/pre_update/{$this->get_object_type()}", $data, $where );
        ...
        do_action( "{$this->get_filter_prefix()}/db/post_update/{$this->get_object_type()}", $where );
    ...
    public function mass_update( $data, $where )
    {
        ...
        do_action( "{$this->get_filter_prefix()}/db/pre_mass_update/{$this->get_object_type()}", $data );

        $data = apply_filters( "{$this->get_filter_prefix()}/db/pre_mass_update/{$this->get_object_type()}", $data, $column_formats );

        if ( false === $wpdb->update( $this->table_name, $data, $where ) ) {
            return false;
        }

        do_action( "{$this->get_filter_prefix()}/db/post_mass_update/{$this->get_object_type()}", $data );
    ...
    public function bulk_delete( $where = [] )
    {
        ...
        do_action( "{$this->get_filter_prefix()}/db/pre_bulk_delete/{$this->get_object_type()}", $where );

        $result = $wpdb->delete( $this->table_name, $where );

        do_action( "{$this->get_filter_prefix()}/db/post_bulk_delete/{$this->get_object_type()}", $where );
    ...
    public function delete( $row_id = 0 ) {
        ...
        do_action( "{$this->get_filter_prefix()}/db/pre_delete/{$this->get_object_type()}", $row_id );
        ...
        do_action( "{$this->get_filter_prefix()}/db/post_delete/{$this->get_object_type()}", $row_id );
    ...
    public function advanced_query( $query_vars=[], $from_cache=true )
    {
        ...
        $results = apply_filters( "{$this->get_filter_prefix()}/db/query/{$this->get_object_type()}", $results, $query_vars );
